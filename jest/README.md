...
#### 举两个`assertion`的例子
  ...
  * [should.js](http://shouldjs.github.io/)
    ...
    `should.js`向所有对象的顶级Object的prototype中添加了should方法，变更了所有对象的should方法，个人感觉不太符合环境隔离的原则。
...
直译覆盖，即测试覆盖率统计。用力检测自己的代码被测试了多少，还有哪些地方没覆盖到。
...
👣 建立新项目，添加各种依赖，`src`与测试目录`__tests__`。
  ...
  <details><summary>创建项目过程</summary>
...
>
> 在升到高层时，这两项技能会互相影响，融合后可衍生高级技能---抽象、分层、重构、架构等。
>
> 当我们经过了几年的学习与工作，感觉到了技能提升瓶颈，是时候将一些时间投入到测试中的时候了。
...
📖 其他经典的编程思想、设计模式一类的玄学书籍，对于提升编写单元测试能力，都会有一定程度的加成提升。
